...
<template>
	<header class="mb-10 flex flex-col items-center">
		...
		/>
		<p
			class="mx-auto my-3 max-w-xl text-center text-sm text-xs text-zinc-600 dark:text-zinc-400"
		>
			{{ props.description }}
		</p>
		<div class="my-8 flex w-full justify-center text-xs md:text-base">
			<div
				class="content-center gap-8 text-sm text-xs text-black dark:text-zinc-300 md:flex"
			>
